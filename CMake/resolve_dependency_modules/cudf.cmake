...
if (VELOX_cudf_VERSION VERSION_GREATER_EQUAL "25.08")
  set(VELOX_CUDF_CXX_STANDARD 20 CACHE STRING "C++ standard for cudf modules")
  set(VELOX_CUDF_CXX_STANDARD_REQUIRED ON CACHE BOOL "C++ standard required for cudf modules")
else()
  set(VELOX_CUDF_CXX_STANDARD ${CMAKE_CXX_STANDARD} CACHE STRING "C++ standard for cudf modules")
  set(VELOX_CUDF_CXX_STANDARD_REQUIRED ON CACHE BOOL "C++ standard required for cudf modules")
endif()
...
set_target_properties(
  cudf
  PROPERTIES
    CXX_STANDARD ${VELOX_CUDF_CXX_STANDARD}
